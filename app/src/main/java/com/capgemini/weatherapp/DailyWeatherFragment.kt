...
import com.capgemini.weatherapp.dummy.DummyContent
...
class DailyWeatherFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val request = OpenWeatherInterface.getInstance().getWeatherAll("https://api.openweathermap.org/data/2.5/onecall?lat=$latt&lon=$longi&units=metric&exclude=hourly,current,minutely&appid=$key")
            ...
            override fun onResponse(call: Call<WeatherAll>, response: Response<WeatherAll>) {
                ...
                if(response.isSuccessful){
                    ...
                    if (view is RecyclerView){
                        ...
                        view.adapter=MyWeatherRecyclerViewAdapter(daily)
                    }
                }
            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_daily_weather_list, container, false)
